...
int main() {
    ...
    // Recursive rule detected: ancestor_step
    ...
    add_recursive_rule(kb, create_atom("ancestor_step"), body_array_7, 2, create_compound("ancestor", args_10, 2));
    ...
    (void)linear_resolve_query_enhanced_disjunctive(kb, goals_0, 2, enhanced_solutions_0);
