...
int main() {
    ...
    add_persistent_fact(kb, create_clone(create_compound("parent", args_1, 2)));
    term_t* args_2[2];
    args_2[0] = create_atom("carol");
    args_2[1] = create_atom("dave");
    add_persistent_fact(kb, create_clone(create_compound("parent", args_2, 2)));
    term_t* args_3[1];
    args_3[0] = create_atom("dave");
    add_persistent_fact(kb, create_clone(create_compound("tall", args_3, 1)));
    ...
    printf("?- ");
    term_t* args_7[2];
    args_7[0] = create_var("$x");
    args_7[1] = create_atom("carol");
    print_term(create_compound("ancestor", args_7, 2));
    printf(" & ");
    term_t* args_8[1];
    args_8[0] = create_var("$x");
    print_term(create_compound("tall", args_8, 1));
    printf(".\n");
    term_t** goals_0 = malloc(2 * sizeof(term_t*));
    term_t* args_9[2];
    args_9[0] = create_var("$x");
    args_9[1] = create_atom("carol");
    goals_0[0] = create_compound("ancestor", args_9, 2);
    term_t* args_10[1];
    args_10[0] = create_var("$x");
    goals_0[1] = create_compound("tall", args_10, 1);
